...
test.describe('User Account', { tag: '@faststore' }, () => {
  ...
  test('validate user can update profile', async ({ browserName, page, accountPage }) => {
  ...
  test('validate user can add addresses', async ({ browserName, page, accountPage, userAddress }) => {
    test.slow(browserName === 'webkit', 'This feature is slow in Safari');
  ...
  test('validate user can edit addresses', async ({ browserName, page, accountPage }) => {
    test.slow(browserName === 'webkit', 'This feature is slow in Safari');
